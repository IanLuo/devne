		...
		let
            ...
            metadata = { inherit name version; };
                    ...
                    units_db_postgres = (wrapInUnit {
                        drv = (units.db.postgres { username = "ss_db";
password = "admin";
database = "password"; });
                    });
                    ...
                    units_language_python = (wrapInUnit {
                        drv = (units.language.python { pythonVersion = "python310";
libs-default = ["typer"
"pynvim"
"pyyaml"
"rich"
...
"flit"]; });
                    ...
                    units_language_pythonRunnablePackage = (wrapInUnit {
                        drv = (units.language.pythonRunnablePackage { name = metadata.name;
